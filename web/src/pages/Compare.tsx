            ...
            {slots.map((value, i) => (
              <label key={i} className="flex flex-col gap-1.5 min-w-[180px] flex-1">
                ...
                <input
                  ...
                  className="rounded-xl border border-slate-200 bg-white px-3 py-2 text-sm text-slate-800 placeholder:text-slate-400 outline-none focus:border-blue-500/40 focus:ring-1 focus:ring-blue-500/20"
