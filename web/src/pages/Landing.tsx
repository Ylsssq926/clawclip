...
const LANDING_LOCAL_COPY = {
  zh: {
    ...
    'landing.hero.title': '真变强，还是只变贵。',
    'landing.hero.kicker': '一次回放，看清证据、判断和代价。',
    'landing.hero.meta': '先看 Demo，再接你的日志。',
    'landing.cta.demoPrimary': '看示例回放',
    'landing.hero.source': 'GitHub',
    'landing.hero.media.badge': '精选样本',
    'landing.hero.media.caption': '一段样本里，同时看见回放、成绩单和成本。',
  ...
  en: {
    'landing.hero.eyebrow': 'Replay · Scorecard · Cost',
    'landing.hero.title': 'Stronger, or just more expensive.',
    'landing.hero.kicker': 'One replay shows the evidence, judgment, and cost.',
    'landing.hero.meta': 'Start with the demo, then swap in your own logs.',
    'landing.cta.demoPrimary': 'Watch demo replay',
    'landing.hero.source': 'GitHub',
    'landing.hero.media.badge': 'Featured sample',
    'landing.hero.media.caption': 'See replay, scorecard, and cost on the same run.',
